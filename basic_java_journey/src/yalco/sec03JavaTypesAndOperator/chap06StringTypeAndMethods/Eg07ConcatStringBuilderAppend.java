package yalco.sec03JavaTypesAndOperator.chap06StringTypeAndMethods;

public class Eg07ConcatStringBuilderAppend {
    public static void main(String[] args) {
        ...
        String str_a5 = str_a1.concat(str_a2); // concat은 문자열이고 null이 아닌 데이터에만 사용할 수 있다.
        ...
        // Concat 은 문자열이고 null이 아닌 것에만 사용할 수 있다.
