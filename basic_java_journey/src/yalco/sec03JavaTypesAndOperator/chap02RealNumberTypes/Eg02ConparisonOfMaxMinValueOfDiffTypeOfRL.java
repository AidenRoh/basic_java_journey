package yalco.sec03JavaTypesAndOperator.chap02RealNumberTypes;

public class Eg02ConparisonOfMaxMinValueOfDiffTypeOfRL {
    public static void main(String[] args) {
        ...
        float fltNum = 0.123456789123456789f; //float은 참고로 뒤에 f 를 붙여줘야한다
    }
}
